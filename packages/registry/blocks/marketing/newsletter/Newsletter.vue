...
// Moderno block — Newsletter (Vue). Copy-paste; edit freely.
...
<template>
  <section class="md-newsletter">
    ...
    <form class="md-newsletter__form" @submit.prevent="handleSubmit">
      <div class="md-newsletter__field">
        <Input v-model="email" label="Correo" name="email" type="email" :placeholder="placeholder" required />
      </div>
