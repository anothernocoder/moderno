...
// Moderno block — PortfolioSections (Vue). Copy-paste; edit freely.
...
const emit = defineEmits<{ select: [project: PortfolioProject] }>()
...
<template>
  <section class="md-portfolio">
    <a
      v-for="{ project, imageStyle } in cards"
      :key="project.href"
      :href="project.href"
      class="md-portfolio__card"
      @click="emit('select', project)"
    >
      <div class="md-portfolio__image" :style="imageStyle" />
