...
// Moderno block — StatusMonitoring (Vue). Copy-paste; edit freely.
      ...
      <li v-for="(service, index) in services" :key="service.id">
        ...
        <div class="md-status-monitoring__row">
          ...
          <div class="md-status-monitoring__meta-group">
            <p v-if="service.uptime || service.lastIncident" class="md-status-monitoring__meta-text">
              <template v-if="service.uptime">{{ service.uptime }} uptime</template>
              <template v-if="service.uptime && service.lastIncident"> · </template>
              <template v-if="service.lastIncident">{{ service.lastIncident }}</template>
            </p>
