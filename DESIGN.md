---
version: alpha
name: Midday Design System
description: Implementation-ready, token-driven UI guidance for Midday — the business stack for modern founders — optimized for consistency, accessibility, and fast delivery across the dashboard web app.
colors:
  primary: "#fafafa"
  on-primary: "#18181b"
  text-primary: "#fafafa"
...
- Product/brand: Midday — The business stack for modern founders
- URL: https://midday.ai/
