...
// Moderno screen — Review (Vue). Copy-paste; edit freely.
...
<template>
  <div class="md-review">
    <div class="md-review__header">
      ...
      <button type="button" class="md-review__link" @click="emit('back')">{{ backLabel }}</button>
    </div>
    ...
    <div class="md-review__footer">
      <Button variant="primary" size="lg" :disabled="submitting" @click="emit('next')">
