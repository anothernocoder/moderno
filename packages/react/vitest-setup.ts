...
// Apply the scroll position synchronously (jsdom never fires a real scroll/paint
// cycle) so the machine's own scroll-settling logic reads back the position it
// just requested instead of drifting back to 0.
