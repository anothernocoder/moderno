<script lang="ts">
  import OnboardingExample from '@moderno-ui/registry/flows/onboarding/Onboarding.example.svelte'
  ...
  let { step = 'welcome' }: { step?: string } = $props()
</script>

<OnboardingExample initialStep={step} />
