...
import { DatePicker, type DatePickerRootProps } from './date-picker'

function renderDatePicker(props: Partial<DatePickerRootProps> = {}) {
  return render(() => (
    <DatePicker.Root defaultValue={['2024-01-15']} {...props}>
